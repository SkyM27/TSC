...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -GWR_NR=$1 -GRD_NR=$2 -GREAD_ORDER=$3 -GWRITE_ORDER=$4 -GTEST_NAME=$5 -GSEED_VAL=$6 -sva top
# eval vsim -novopt -quiet -coverage +code=bcesft +notimingchecks +nowarnTSCALE -GWR_NR=$1 -GRD_NR=$2 -GREAD_ORDER=$3 -GWRITE_ORDER=$4 -GTEST_NAME=$5 -GSEED_VAL=$6 -sva top
